<template>
  <footer
    class="footer bg-neutral text-neutral-content items-center p-4 font-ws"
  >
    <aside class="px-5 lg:px-10 grid-flow-col items-center">
      <a href="#hero" class="text-3xl font-bold font-ws">Hafid.</a>
